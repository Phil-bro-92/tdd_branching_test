...
class CompoundInterestTest(unittest.TestCase):
    ...
    def test_above_outcome_1(self):
        ...
        self.assertEqual(732.81, outcome.calculate_compound_interest(0))
    ...
    def test_above_outcome_2(self):
        ...
        self.assertEqual(181.94, outcome.calculate_compound_interest(0))
    ...
    def test_above_outcome_3(self):
        ...
        self.assertEqual(149058.55, outcome.calculate_compound_interest(0))


    # Should return 0.00 given 0 principal, 10 percent, 1 year
    def test_above_outcome_4(self):
        outcome = CompoundInterest(0, 1, 0.1)
        self.assertEqual(0.00, outcome.calculate_compound_interest(0))
    ...
    def test_above_outcome_5(self):
        ...
        self.assertEqual(100.00, outcome.calculate_compound_interest(0))
